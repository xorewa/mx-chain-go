...
// ErrInvalidDRWAReceiverSeeds signals an invalid or unsupported S1 qualification seed list.
// NON_NORMATIVE_DRWA_PROTOTYPE
var ErrInvalidDRWAReceiverSeeds = errors.New("invalid non-normative DRWA prototype receiver seeds")
...
type ArgsGenesisBlockCreator struct {
	...
	DRWACEBEpoch            uint32
	DRWAReceiverSeeds       []config.DRWAReceiverSeedConfig
