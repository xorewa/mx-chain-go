...
func TestF1TQualificationReachesLegacyProductionConversionOnce(t *testing.T) {
	...
	profileBinding := f1t.SemanticProfileBinding{
		ID: f1t.ProfileLegacy, EvaluationEpoch: 2,
		EffectiveEpochs: f1t.SemanticEffectiveEpochs{SCDeployEnableEpoch: 0, SCProcessorV2EnableEpoch: 3,
			SupernovaEnableEpoch: 2, DynamicESDTEnableEpoch: 1, DRWAEnforcementEnableEpoch: 2},
		ExpectedFlags: f1t.SemanticProfileFlags{SCDeployFlag: true, DRWAEnforcementFlag: true},
	}
