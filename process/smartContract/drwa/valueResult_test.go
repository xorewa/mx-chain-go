...
func TestDRWASettlementReceiptRoundTripAndIdentityBinding(t *testing.T) {
...
func TestDRWARefundEnvelopeRoundTrip(t *testing.T) {
...
func TestDRWAValueResultsRejectMissingIdentity(t *testing.T) {
